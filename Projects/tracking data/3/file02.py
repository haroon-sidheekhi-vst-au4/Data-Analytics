...
mviz.plot_events( events.loc[1722:1723], color='k', indicators = ['Marker','Arrow'], annotate=True )
...
#PPCF,xgrid,ygrid = mpc.generate_pitch_control_for_event(1719, events, tracking_home, tracking_away, params, GK_numbers, field_dimen = (106.,68.,), n_grid_cells_x = 50)
#mviz.plot_pitchcontrol_for_event( 1719, events,  tracking_home, tracking_away, PPCF, annotate=True )

#PPCF,xgrid,ygrid = mpc.generate_pitch_control_for_event(1720, events, tracking_home, tracking_away, params, GK_numbers, field_dimen = (106.,68.,), n_grid_cells_x = 50)
#mviz.plot_pitchcontrol_for_event(1720, events,  tracking_home, tracking_away, PPCF, annotate=True )

#PPCF,xgrid,ygrid = mpc.generate_pitch_control_for_event(1722, events, tracking_home, tracking_away, params, GK_numbers, field_dimen = (106.,68.,), n_grid_cells_x = 50)
#mviz.plot_pitchcontrol_for_event(1722, events,  tracking_home, tracking_away, PPCF, annotate=True )
