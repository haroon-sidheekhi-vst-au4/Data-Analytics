...
def to_metric_coordinates(data,field_dimen=(106.,68.) ):
    ...
    for column in x_columns:
        data[column] = (data[column] - 0.5) * field_dimen[0]
    
    for column in y_columns:
        data[column] = -1 * (data[column] - 0.5) * field_dimen[1]
...
def to_single_playing_direction(home,away,events):
    ...
    for team in [home,away,events]:
        ...
        team.loc[second_half_idx:, columns] = np.multiply(team.loc[second_half_idx:, columns], -1)
