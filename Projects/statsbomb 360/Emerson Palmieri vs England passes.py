# -*- coding: utf-8 -*-
"""
Created on Wed May 31 23:41:38 2023
...
player1_df = df[(df['player_name'] == 'Emerson Palmieri dos Santos') & (df['type_name'] == 'Pass')].reset_index(drop=True)
...
#title    
fig.text(
    0.515, 0.98, "Emerson Palmieri- Left back - ITALY", size=18,
...
fig.text(
    0.515, 0.949,
    'Position of players during the pass against England at the minute of '+ player1_df['minute'].astype(str).str.cat(sep=', ')  +'"',
    size=15,
    ha="center", color="#000000"
)