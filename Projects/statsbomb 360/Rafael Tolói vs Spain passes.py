# -*- coding: utf-8 -*-
"""
Created on Thu Jun  1 12:30:32 2023
...
player1_df = df[(df['player_name'] == 'Rafael Tolói') & (df['type_name'] == 'Pass')].reset_index(drop=True)
...
#title    
fig.text(
    0.515, 0.98, "Rafael Tolói- Right back - ITALY - [EURO2020]", size=18,
...
fig.text(
    0.515, 0.949,
    'Position of players during the pass against Spain at the minute of '+ player1_df['minute'].astype(str).str.cat(sep=', ')  +'"',
    size=15,
    ha="center", color="#000000"
)