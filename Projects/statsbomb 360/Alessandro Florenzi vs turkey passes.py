# -*- coding: utf-8 -*-
"""
Created on Thu Jun  1 00:04:59 2023
...
player1_df = df[(df['player_name'] == 'Alessandro Florenzi') & (df['type_name'] == 'Pass')].reset_index(drop=True)
...
#title    
fig.text(
    0.515, 0.98, "Alessandro Florenzi - Right back - ITALY - [EURO2020]", size=18,
...
fig.text(
    0.515, 0.949,
    'Position of players during the pass against Turkey at the minute of '+ player1_df['minute'].astype(str).str.cat(sep=', ')  +'"',
    size=15,
    ha="center", color="#000000"
)