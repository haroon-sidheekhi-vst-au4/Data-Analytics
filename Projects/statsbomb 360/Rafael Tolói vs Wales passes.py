# -*- coding: utf-8 -*-
"""
Created on Thu Jun  1 12:04:28 2023
...
fig.text(
    0.515, 0.949,
    'Position of players during the pass against Wales at the minute of '+ player1_df['minute'].astype(str).str.cat(sep=', ')  +'"',
    size=15,
    ha="center", color="#000000"
)