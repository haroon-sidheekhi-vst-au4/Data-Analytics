...
#Drawing the pitch   
    ...
    fig = pitch.draw(figsize=(16, 11), constrained_layout=True, tight_layout=False)
    fig, ax = pitch.draw()
...
ax.set_title('Touches by M.Salah against spurs in 2018-19 UEFA Final',fontsize = 12)
plt.show()
