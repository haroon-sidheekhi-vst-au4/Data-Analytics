# -*- coding: utf-8 -*-
"""
Created on Mon Oct 31 21:25:07 2022
...
with open('E:\SoccermaticsForPython-master\wyscout\events\events_England.json') as d2:
    data = json.load(d2)    
df_match = json_normalize(data, sep = "_")
...
with open('E:\SoccermaticsForPython-master\wyscout\events\minutes_played_per_game_England.json') as f:
